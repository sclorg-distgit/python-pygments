...
%files
%defattr(-,root,root,-)
%doc AUTHORS CHANGES doc/reST LICENSE TODO
%{python3_sitelib}/*
%{_bindir}/pygmentize
%lang(en) %{_mandir}/man1/pygmentize.1.gz

%changelog
* Fri Jun 16 2017 Charalampos Stratakis <cstratak@redhat.com> - 2.2.0-1
- Updated to 2.2.0 for rh-python36

* Sat Feb 13 2016 Robert Kuska <rkuska@redhat.com> - 2.1-1
- Updated to 2.1

* Wed Jan 21 2015 Matej Stuchlik <mstuchli@redhat.com> - 1.6-1
- Updated to 1.6
